...
const _serverinsertedhtml = __webpack_require__(/*! ../../shared/lib/server-inserted-html */ "./node_modules/next/dist/shared/lib/server-inserted-html.js");
...
exports.useRouteInterceptor = void 0;
const navigation_1 = __webpack_require__(/*! next/navigation */ "./node_modules/next/navigation.js");
const react_1 = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const utils_1 = __webpack_require__(/*! ./utils */ "./src/utils.ts");
const event_emitter_1 = __importDefault(__webpack_require__(/*! event-emitter */ "./node_modules/event-emitter/index.js"));
function useRouteInterceptor() {
    const router = (0, navigation_1.useRouter)();
    const [onRouteChangeStartFns] = (0, react_1.useState)((0, event_emitter_1.default)());
    const pathname = (0, navigation_1.usePathname)();
    const searchParams = (0, navigation_1.useSearchParams)();
    const routerUrlChangeEvent = (0, utils_1.useNavigationEvent)();
    const routerProxy = (0, react_1.useMemo)(() => new Proxy(router, {
        get: (target, prop) => {
    ...
    const currentUrl = (0, react_1.useMemo)(() => {
    ...
    (0, react_1.useEffect)(() => {
        if (routerUrlChangeEvent === currentUrl)
            return;
...
exports.useRouteInterceptor = useRouteInterceptor;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.useNavigationEvent = void 0;
const navigation_1 = __webpack_require__(/*! next/navigation */ "./node_modules/next/navigation.js");
const react_1 = __webpack_require__(/*! react */ "./node_modules/react/index.js");
function useNavigationEvent() {
    const pathname = (0, navigation_1.usePathname)();
    const searchParams = (0, navigation_1.useSearchParams)();
    const [newUrl, setNewUrl] = (0, react_1.useState)();
    (0, react_1.useEffect)(() => {
        if (!searchParams)
            return;
